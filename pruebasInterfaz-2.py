...
class Nodo:
    ...
    def editarNodosAdyacentes(self,nodosAdyacentes):
        self.nodosAdyacentes = nodosAdyacentes
    def editarDistanciaNodosAdyacentes(self,distanciaNodosAdyacentes):
        self.distanciaNodosAdyacentes = distanciaNodosAdyacentes
    def editarTipoCable_NodosAdyacentes(self,tipoCable_NodosAdyacentes):
        self.tipoCable_NodosAdyacentes = tipoCable_NodosAdyacentes
    
    def obtenerNodosAdyacentes(self):
        return self.nodosAdyacentes
    def obtenerDistanciaNodosAdyacentes(self):
        return self.distanciaNodosAdyacentes
    def obtenerTipoCable_NodosAdyacentes(self):
        return self.tipoCable_NodosAdyacentes
